                  ...
                  fs.writeFileSync(LOCAL_PATH, res.data);
                            ...
                            const db = new sqlite3.Database(LOCAL_PATH);
                                  await new Promise((resolve, reject) => {
                                          db.serialize(() => {
                                                    db.run(`CREATE TABLE IF NOT EXISTS Projects (id INTEGER PRIMARY KEY AUTOINCREMENT, author TEXT, projectMETA TEXT, bs64tarzstsb3 TEXT);`);
                                                              db.run(`CREATE TABLE IF NOT EXISTS Users (id TEXT PRIMARY KEY, username TEXT UNIQUE, email TEXT, password TEXT, userMETA TEXT);`, (err) => {
